...
from CalculoPotencia_J1C_04 import CalculoPotencia_J1C_04  # grc-generated hier_block
...
class Modulacion_PM_J1C_04(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulacion PM J1C04", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulacion PM J1C04")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Modulacion_PM_J1C_04")
        ...
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, "Frecuncia mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Am_win = RangeWidget(self._Am_range, self.set_Am, "Amplitur mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.CalculoPotencia_J1C_04_0 = CalculoPotencia_J1C_04(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.CalculoPotencia_J1C_04_0)
        ...
        self.connect((self.Envolvente_Compleja_PM_J1C_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Envolvente_Compleja_PM_J1C_0, 0))
        self.connect((self.blocks_complex_to_mag_0, 0), (self.CalculoPotencia_J1C_04_0, 0))
...
def main(top_block_cls=Modulacion_PM_J1C_04, options=None):
